...
#if NR_PS2 > 2
  ps2port[2].gpio_clk = GPIO_RP2U_PS2_CLK;
  ps2port[2].gpio_data = GPIO_RP2U_PS2_DATA;
  ps2port[3].gpio_clk = GPIO_RP2U_PS2_CLK2;
  ps2port[3].gpio_data = GPIO_RP2U_PS2_DATA2;
#endif
